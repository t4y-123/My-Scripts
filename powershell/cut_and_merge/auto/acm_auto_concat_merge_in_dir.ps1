...
#随便打开一个concat合并的视频
Invoke-FileByType  -LiteralPath $auto_merge_work_dir -IncludeExtensions $video_types_list -IncludePrefix $auto_concat_output_prefix_list
